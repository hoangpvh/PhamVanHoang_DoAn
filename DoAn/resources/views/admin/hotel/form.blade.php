                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('c_name') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Tên khách sạn <sup
                                    class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" maxlength="100" class="form-control"
                                    placeholder="Tên phòng khách sạn" name="h_name"
                                    value="{{ old('h_name', isset($hotel) ? $hotel->h_name : '') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" placeholder="Giá" name="h_price"
                                            value="{{ old('h_price', isset($hotel) ? $hotel->h_price : '') }}">
                                        <span class="text-danger ">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" placeholder="Điện thoại liên hệ"
                                            name="h_phone"
                                            value="{{ old('h_phone', isset($hotel) ? $hotel->h_phone : '') }}">
                                        <span class="text-danger ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" placeholder="Địa chỉ"
                                            name="h_address"
                                            value="{{ old('h_address', isset($hotel) ? $hotel->h_address : '') }}">
                                        <span class="text-danger ">
                        ...
                        <div class="form-group {{ $errors->first('h_description') ? 'has-error' : '' }}">
                            ...
                            <div>
                                <textarea name="h_description" id="h_description" cols="20" rows="8" style="resize:vertical; height: 218px;"
                                    class="form-control" placeholder="Mô tả ...">{{ old('h_description', isset($hotel) ? $hotel->h_description : '') }}</textarea>
                                <span class="text-danger">
                                    <p class="mg-t-5">{{ $errors->first('h_description') }}</p>
                                </span>
                                <script>
                        ...
                        <div class="form-group {{ $errors->first('h_content') ? 'has-error' : '' }}">
                            ...
                            <div>
                                <textarea name="h_content" id="h_content" cols="20" rows="8" style="resize:vertical; height: 218px;"
                                    class="form-control" placeholder="Mô tả ...">{{ old('h_content', isset($hotel) ? $hotel->h_content : '') }}</textarea>
                                <span class="text-danger">
                                    <p class="mg-t-5">{{ $errors->first('h_content') }}</p>
                                </span>
                                <script>
                                    ckeditor(h_content);
                                </script>
                    ...
                    <div class="card-body" style="min-height: 288px">
                        <div class="form-group">
                            ...
                            @if (isset($hotel) && !empty($hotel->h_image))
                                <img src="{{ asset(pare_url_file($hotel->h_image)) }}" alt=""

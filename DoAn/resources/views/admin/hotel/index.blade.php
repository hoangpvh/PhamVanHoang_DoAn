                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools">
                                <div class="btn-group">
                                    <a href="{{ route('hotel.create') }}"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle; width:20%;">
                                                    @if (isset($hotel) && !empty($hotel->h_image))
                                                        <img src="{{ asset(pare_url_file($hotel->h_image)) }}"
                                                            alt="" class="margin-auto-div img-rounded"
                                                            id="image_render" style="height: 140px; width:100%;">
                                                    @else
                                                ...
                                                <td style="vertical-align: middle; width:35%;">
                                                    <p><b>Địa điểm :</b>
                                                        {{ isset($hotel->location) ? $hotel->location->l_name : '' }}</p>
                                                    <p><b>Địa chỉ :</b> {{ $hotel->h_address }}</p>
                                                    <p><b>Điện thoại :</b> {{ $hotel->h_phone }}</p>
                                                    <p><b>Giá từ :</b> {{ number_format($hotel->h_price, 0, ',', '.') }} vnđ
                                                    </p>
                                                </td>
                                                {{-- <td>{{ $types[$category->c_type] }}</td> --}}
                                                <td class="text-center" style="vertical-align: middle;">
                                                    {{ $status[$hotel->h_status] }}</td>
                                                <td class="text-center" style="vertical-align: middle;">
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('hotel.update', $hotel->id) }}">

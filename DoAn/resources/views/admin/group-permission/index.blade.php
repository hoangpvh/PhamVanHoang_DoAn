                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools">
                                <div class="btn-group">
                                    <a href="{{ route('group.permission.create') }}"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('group.permission.update', $permissionGroup->id) }}">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm btn-delete btn-confirm-delete"
                                                        href="{{ route('group.permission.delete', $permissionGroup->id) }}">

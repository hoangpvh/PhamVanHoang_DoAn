                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('name') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Tên nhóm quyền <sup
                                    class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" maxlength="100" class="form-control" placeholder="Tên nhóm quyền"
                                    name="name"
                                    value="{{ old('name', isset($permissionGroup) ? $permissionGroup->name : '') }}">

                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('l_name') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Tên địa điểm <sup
                                    class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" maxlength="100" class="form-control" placeholder="Tên địa điểm"
                                    name="l_name"
                                    value="{{ old('l_name', isset($location) ? $location->l_name : '') }}">
                                <span class="text-danger ">
                                    <p class="mg-t-5">{{ $errors->first('l_name') }}</p>
                                </span>
                            </div>
                        </div>
                        <div class="form-group {{ $errors->first('l_description') ? 'has-error' : '' }}">
                            ...
                            <div>
                                <textarea name="l_description" cols="20" rows="8" style="resize:vertical; height: 218px;"
                                    class="form-control" placeholder="Mô tả ...">{{ old('l_description', isset($location) ? $location->l_description : '') }}</textarea>
                                <span class="text-danger">
                                    <p class="mg-t-5">{{ $errors->first('l_description') }}</p>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="card-body" style="min-height: 288px">
                        <div class="form-group">
                            ...
                            @if (isset($location) && !empty($location->l_image))
                                <img src="{{ asset(pare_url_file($location->l_image)) }}" alt=""

                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="l_name" class="form-control mg-r-15"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle; width:20%;">
                                                    @if (isset($location) && !empty($location->l_image))
                                                        <img src="{{ asset(pare_url_file($location->l_image)) }}"
                                                ...
                                                <td class="text-center" style="vertical-align: middle;">
                                                    {{ $status[$location->l_status] }}</td>
                                                <td class="text-center" style="vertical-align: middle;">
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('location.update', $location->id) }}">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm btn-delete btn-confirm-delete"
                                                        href="{{ route('location.delete', $location->id) }}">

        ...
        <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('t_title') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Tiêu đề tour <sup
                                    class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" class="form-control" placeholder="Tiêu tour" name="t_title"
                                    value="{{ old('t_title', isset($tour) ? $tour->t_title : '') }}">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="t_number_guests"
                                        value="{{ old('t_number_guests', isset($tour) ? $tour->t_number_guests : '') }}">
                                    <span class="text-danger">
                                        <p class="mg-t-5">{{ $errors->first('t_location_id') }}</p>
                                    </span>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="number" max="100" class="form-control" placeholder=""
                                            name="t_sale"
                                            value="{{ old('t_sale', isset($tour) ? $tour->t_sale : '') }}">
                                        <span class="text-danger">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="" name="t_price_adults"
                                        value="{{ old('t_price_adults', isset($tour) ? $tour->t_price_adults : '') }}">
                                    <span class="text-danger">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder=""
                                            name="t_price_children"
                                            value="{{ old('t_price_children', isset($tour) ? $tour->t_price_children : '') }}">
                                        <span class="text-danger">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="t_move_method"
                                        value="{{ old('t_move_method', isset($tour) ? $tour->t_move_method : '') }}">
                                    <span class="text-danger">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="t_starting_gate"
                                            value="{{ old('t_starting_gate', isset($tour) ? $tour->t_starting_gate : '') }}">
                                        <span class="text-danger">
                        ...
                        <div class="form-group {{ $errors->first('t_journeys') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Hành trình <sup
                                    class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" class="form-control" placeholder="Hành trình"
                                    name="t_journeys"
                                    value="{{ old('t_journeys', isset($tour) ? $tour->t_journeys : '') }}">
                                <span class="text-danger ">
                        ...
                        <div class="form-group {{ $errors->first('t_schedule') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Lịch trình <sup
                                    class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" class="form-control" placeholder="Lịch trình"
                                    name="t_schedule"
                                    value="{{ old('t_schedule', isset($tour) ? $tour->t_schedule : '') }}">
                                <span class="text-danger ">
                        ...
                        <div class="form-group {{ $errors->first('t_description') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <textarea name="t_description" id="t_description" cols="30" rows="10" class="form-control"
                                    style="height: 225px;">{{ old('t_description', isset($tour) ? $tour->t_description : '') }}</textarea>
                                <script>
                        ...
                        <div class="form-group {{ $errors->first('t_content') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <textarea name="t_content" id="t_content" cols="30" rows="10" class="form-control"
                                    style="height: 225px;">{{ old('t_content', isset($tour) ? $tour->t_content : '') }}</textarea>
                                <script>
                                    ckeditor(t_content);
                                </script>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="btn-set">
                            <button type="submit" name="submit" value="{{ isset($tour) ? 'update' : 'create' }}"
                                class="btn btn-info">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="t_start_date"
                                value="{{ old('t_start_date', isset($tour) ? $tour->t_start_date : '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="t_end_date"
                                value="{{ old('t_end_date', isset($tour) ? $tour->t_end_date : '') }}">
                    ...
                    <div class="card-body" style="min-height: 288px">
                        <div class="form-group">
                            ...
                            @if (isset($tour) && !empty($tour->t_image))
                                <img src="{{ asset(pare_url_file($tour->t_image)) }}" alt=""

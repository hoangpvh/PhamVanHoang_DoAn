                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-3">
                                    <div class="form-group">
                                        <input type="text" name="a_title" class="form-control mg-r-15"
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools">
                                <div class="btn-group">
                                    <a href="{{ route('article.create') }}"><button type="button"
                                    ...
                                    @if (!$articles->isEmpty())
                                        ...
                                        @foreach ($articles as $article)
                                            <tr>
                                                ...
                                                <td class=" text-center" style="vertical-align: middle;">
                                                    {{ $actives[$article->a_active] }}</td>
                                                <td class=" text-center" style="vertical-align: middle;">
                                                    {{ $article->created_at }}</td>
                                                <td class="text-center" style="vertical-align: middle;">
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('article.update', $article->id) }}">

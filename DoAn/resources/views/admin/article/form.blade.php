                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('a_title') ? 'has-error' : '' }} ">
                            <label for="inputEmail3" class="control-label default">Tiêu đề bài viết <sup
                                    class="text-danger">(*)</sup></label>
                            <div>
                                <input type="text" maxlength="180" class="form-control"
                                    placeholder="Tiêu đề bài viết" name="a_title"
                                    value="{{ old('a_title', isset($article) ? $article->a_title : '') }}">
                                <span class="text-danger ">
                                    <p class="mg-t-5">{{ $errors->first('a_title') }}</p>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">
                                        <p class="mg-t-5">{{ $errors->first('a_category_id') }}</p>
                                    </span>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">
                                        <p class="mg-t-5">{{ $errors->first('a_active') }}</p>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ $errors->first('a_description') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <textarea name="a_description" id="a_description" cols="30" rows="10" class="form-control"
                                    style="height: 225px;">{{ old('a_description', isset($article) ? $article->a_description : '') }}</textarea>
                                <script>

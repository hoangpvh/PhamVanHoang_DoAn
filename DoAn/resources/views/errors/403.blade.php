        ...
        <div class="error">
            <div class="container-floud">
                <div class="col-xs-12 text-center default">
                    ...
                    <button type="button" class="btn btn-info btn-flat margin btn-lg" onclick="window.history.back()"><i
                            class="fa fa-hand-o-left" aria-hidden="true"></i> Quay trở lại</button>
                </div>
            </div>
        </div>
        <!-- Error Page -->

<div>
    <div style="background-color:#c5ffff;text-align: center;border-color: green; border-style: solid; border-width: 5px;">
    ...
    Ngày khởi hành: <b> {{ $tour->t_start_date }} </b><br>
    Ngày kết thúc: <b> {{ $tour->t_end_date }} </b><br>
    ...
    <div style="background-color:#ddd;margin-top:8px">
        <div style="margin-left:8px">
            ...
            <b style="color:red"> Nếu quá thời hạn trên, quý khách chưa thanh toán, Minh Duc Travel sẽ huỷ booking này</b><br>
        </div>
    ...
    <div style="background-color:#ddd;margin-top:8px">
        <div style="margin-left:8px">
            ...
            Người lớn:<b> {{ $bookTour->b_number_adults }} </b><br>
            Trẻ em: <b>{{ $bookTour->b_number_children }}</b><br>
            Trẻ em 2-6 tuổi: <b>{{ $bookTour->b_number_child6 }}</b><br>
            Trẻ em dưới 2 tuổi: <b>{{ $bookTour->b_number_child2 }}</b>
        </div>
    </div>
</div>

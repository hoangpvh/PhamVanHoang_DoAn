            ...
            <div class="row d-flex contact-info">
                ...
                <div class="col-md-3 d-flex">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a href="mailto:info@yoursite.com">pvhoangk45@gmail.com</a></p>
                    </div>
                </div>
                <div class="col-md-3 d-flex">
                    <div class="align-self-stretch box p-4 text-center">
        ...
        <div class="container">
            <div class="row block-9">
                <div class="col-md-6 order-md-last">
                    <p></p>
                    <form
                        action="{{ !isset($bookTour) ? route('post.book.tour', $tour->id) : route('user.update-tour', $bookTour->id) }}"
                        method="POST" class="bg-light p-5 contact-form">
                        @csrf
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Họ và tên <sup
                                    class="text-danger">(*)</sup></label>
                            <input type="text" name="b_name"
                                value="{{ old('b_name', isset($user) ? $user->name : '') }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="b_email"
                                value="{{ old('b_email', isset($user) ? $user->email : '') }}" class="form-control"
                                placeholder="Email">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Số điện thoại <sup
                                    class="text-danger">(*)</sup></label>
                            <input type="text" name="b_phone"
                                value="{{ old('b_phone', isset($user) ? $user->phone : '') }}" class="form-control"
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Địa chỉ <sup
                                    class="text-danger">(*)</sup></label>
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Số người lớn <sup
                                    class="text-danger">(*)</sup></label>
                            <input type="number" name="b_number_adults"
                                value="{{ old('b_number_adults', isset($bookTour) ? $bookTour->b_number_adults : '') }}"
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Số trẻ em (6 - 12 tuổi) <sup
                                    class="text-danger">(*)</sup></label>
                            <input type="number" min="0" name="b_number_children"
                                value="{{ old('b_number_children', isset($bookTour) ? $bookTour->b_number_children : '0') }}"
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Số trẻ em (2-6 tuổi) <sup
                                    class="text-danger">(*)</sup></label>
                            <input type="number" min="0" name="b_number_child6"
                                value="{{ old('b_number_child6', isset($bookTour) ? $bookTour->b_number_child6 : '0') }}"
                                class="form-control" placeholder="Số trẻ em">
                            @if ($errors->first('b_number_children'))
                                <span class="text-danger">{{ $errors->first('b_number_children') }}</span>
                            @endif
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Số trẻ em (Dưới 2 tuổi) <sup
                                    class="text-danger">(*)</sup></label>
                            <input type="number" min="0" name="b_number_child2"
                                value="{{ old('b_number_child2', isset($bookTour) ? $bookTour->b_number_child2 : '0') }}"
                                class="form-control a" placeholder="Số trẻ em">
                            @if ($errors->first('b_number_children'))
                                <span class="text-danger">{{ $errors->first('b_number_children') }}</span>
                            @endif
                        </div>
                        <div class="form-group">
                            ...
                            <textarea name="b_note" placeholder="Thông tin chi tiết để chúng tôi liên hệ nhanh chóng..." id="message"
                                cols="20" rows="5" class="form-control">{{ old('b_note', isset($bookTour) ? $bookTour->b_note : '') }}</textarea>
                        </div>
                        <div class="col-md-12 text-center">
                            <div class="form-group">
                                <input type="submit" value="{{ isset($bookTour) ? 'Sửa Tour' : 'Đặt Tour' }}"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 20%;">
                                        ...
                                        vnd</td>
                                    <td style="width: 20%;">
                                        {{ number_format($tour->t_price_children - ($tour->t_price_children * $tour->t_sale) / 100, 0, ',', '.') }}
                                        vnd</td>
                                    <td style="width: 20%;">
                                        {{ number_format((($tour->t_price_children - ($tour->t_price_children * $tour->t_sale) / 100) * 50) / 100, 0, ',', '.') }}
                                        vnd</td>
                                    <td style="width: 20%;">
                                        {{ number_format((($tour->t_price_children - ($tour->t_price_children * $tour->t_sale) / 100) * 25) / 100, 0, ',', '.') }}
                                        vnd</td>
                                </tr>
                            </tbody>
                        </table>

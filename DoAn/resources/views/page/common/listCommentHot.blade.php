<section class="ftco-section testimony-section bg-bottom"
    style="background-image: url({{ asset('page/images/bg_1.jpg') }});">
                                ...
                                <div class="testimony-wrap py-4">
                                    <div class="text item-comment">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="user-img"
                                                style="background-image: url({{ asset(isset($comment) && !empty($comment->user->avatar) ? asset(pare_url_file($comment->user->avatar)) : 'page/images/person_1.jpg') }})">
                                            </div>
                                            <div class="pl-3">

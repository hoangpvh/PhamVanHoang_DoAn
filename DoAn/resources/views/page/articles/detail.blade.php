                        ...
                        <div class="pt-5 mt-5 py-5" style="border-top: 1px solid #ccc;">
                            ...
                            <div class="comment-form-wrap pt-5">
                                <h3 class="mb-5" style="font-size: 20px; font-weight: bold;">
                                    {{ Auth::guard('users')->check() ? 'Bình luận về tour du lịch' : 'Bạn cần đăng nhập để bình luận' }}
                                </h3>
                                @if (Auth::guard('users')->check())
                                    <form action="#" class="p-5 bg-light">
                                        <div class="form-group">
                                            ...
                                            <span class="text-errors-comment" style="display: none;">Vui lòng nhập nội dung
                                                bình luận !!!</span>
                                        </div>
                                        <div class="form-group">
                                            <input type="" value="Gửi bình luận"
                                                class="btn py-3 px-4 btn-primary btn-comment"
                    ...
                    <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                        <div class="categories">
                            ...
                            @foreach ($categories as $category)
                                <li><a href="#">{{ $category->c_name }}
                                        <span>({{ isset($category->news) ? $category->news->count() : 0 }})</span></a></li>
                            @endforeach
                        </div>
                    </div>
                            ...
                            @foreach ($articles as $article)
                                <div class="block-21 mb-4 d-flex">
                                    <a class="blog-img mr-4"
                                        style="background-image: url({{ $article->a_avatar ? asset(pare_url_file($article->a_avatar)) : asset('admin/dist/img/no-image.png') }}););"></a>
                                    <div class="text">
                                        <h3 class="heading">
                                            <a
                                                href="{{ route('articles.detail', ['id' => $article->id, 'slug' => safeTitle($article->a_title)]) }}">
                                        ...
                                        <div class="meta">
                                            ...
                                            <div><a href="#"><span class="fa fa-user"></span>
                                                    {{ $article->user ? $article->user->name : '' }}</a></div>

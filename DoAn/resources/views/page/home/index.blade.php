...
@section('title', 'Cuộc đời là những chuyến đi | Minh Duc Travel')
@section('style')
@stop
@section('content')
            ...
            <div class="row d-flex">
                <div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <p>Các bạn hãy tìm đến với Minh Duc Travel để được đi đến bất cứ nơi nào trên thế giới. Dành cho người có niềm đam mê bất tận với du lịch!</p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <div class="img"  style="background-image: url({{ asset('page/images/bg_2.jpg') }});">
                        <div class="overlay"></div>
                        <h2>Chúng tôi là Công ty Du lịch Minh Duc Travel</h2>

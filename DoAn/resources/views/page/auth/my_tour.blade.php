                                ...
                                @foreach ($bookTours as $tour)
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; width: 50%">
                                            ...
                                            <p><b>Số người lớn : </b> {{ $tour->b_number_adults }} - <b>Thành tiền</b>:
                                                {{ number_format($tour->b_number_adults * $tour->b_price_adults, 0, ',', '.') }}
                                                vnd</p>
                                            <p><b>Số trẻ em (6-12 tuổi) :</b> {{ $tour->b_number_children }} - <b>Thành
                                                    tiền</b>:
                                                {{ number_format($tour->b_number_children * $tour->b_price_children, 0, ',', '.') }}
                                                vnd</p>
                                            <p><b>Số trẻ em (2-6 tuổi) :</b> {{ $tour->b_number_child6 }} - <b>Thành
                                                    tiền</b>:
                                                {{ number_format($tour->b_number_child6 * $tour->b_price_child6, 0, ',', '.') }}
                                                vnd</p>
                                            <p><b>Số trẻ em (dưới 2 tuổi) :</b> {{ $tour->b_number_child2 }} - <b>Thành
                                                    tiền</b>:
                                                {{ number_format($tour->b_number_child2 * $tour->b_price_child2, 0, ',', '.') }}
                                                vnd</p>

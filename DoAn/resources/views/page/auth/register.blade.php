            ...
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('page.home') }}">Trang chủ <i
                                    class="fa fa-chevron-right"></i></a></span> <span>Đăng ký <i
            ...
            <div class="row block-9">
                <div class="col-md-12 order-md-last d-flex">
                    <form action="{{ route('post.account.register') }}" method="POST" class="bg-light p-5 contact-form">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Mật khẩu <sup
                                    class="text-danger">(*)</sup></label>
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="control-label">Nhập lại mật khẩu <sup
                                    class="text-danger">(*)</sup></label>

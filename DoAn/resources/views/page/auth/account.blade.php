            ...
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('page.home') }}">Trang chủ <i
                                    class="fa fa-chevron-right"></i></a></span> <span>Tài khoản <i
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 ftco-animate py-md-5">
                    <form action="{{ route('update.info.account', $user->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="control-label">Email <sup
                                            class="text-danger">(*)</sup></label>
                            ...
                            <div class="col-md-3 ">
                                ...
                                <div class="col-md-12 text-center vcard bio">
                                    <img src="{{ $user->avatar ? asset(pare_url_file($user->avatar)) : asset('page/images/user_default.png') }}"
                                        alt="" class="img-circle avatar" width="100%">
                                </div>
                            </div>
                        </div>
